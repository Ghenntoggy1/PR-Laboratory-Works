...
from Laboratory_Work_1_Scraper_HTTP_Requests.CurrencyConvertor import construct_price_currency
from Laboratory_Work_1_Scraper_HTTP_Requests.UrllibHTMLRequester import UrllibHTMLRequester
from Laboratory_Work_1_Scraper_HTTP_Requests.PhoneEntityProcessor import *
from Laboratory_Work_1_Scraper_HTTP_Requests.WebScraper import WebScraper
from Laboratory_Work_1_Scraper_HTTP_Requests.TCPHTMLRequester import TCPHTMLRequester
from datetime import timezone
import datetime
from Laboratory_Work_1_Scraper_HTTP_Requests.FilteredPhones import FilteredPhones
...
def start_process(web_scraper: WebScraper) -> tuple[FilteredPhones, list[PhoneEntity]]:
    ...
    products_html = web_scraper.get_tag_from_soup(soup, "div", "product-items-5 mt-3 ga-list")
    bs_products_html = BeautifulSoup(str(products_html), Constants.PARSER_TYPE)
    phones_html = web_scraper.get_tag_from_soup(bs_products_html, "div", "product-card bg-color-1c br-20 position-relative overflow-hidden h-100 product-item")
